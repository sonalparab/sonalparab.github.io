  ...
  return (
    <div>
      ...
      <HobbyEntry image1={BowlingPic1} image2={BowlingPic2} name="Bowling" dimensions={[310, 250, 310, 300]}
        description="I have been bowling since I was little for fun and was on my high school's Girls Bowling team. I continue to bowl for fun with old teammates during holiday breaks." />
