      ...
      <div>
        <div>
          ...
          <ProjectCard name="TypePacer Game" projectLink="https://github.com/sonalparab/TypePacer" technologies={["Flask", "Python", "SQLite", "HTML", "Javascript", "Git"]}
            description="I worked with a team of 4 to recreate the web game TypeRacer, which is a speed typing game. After seeing their words per minute (WPM), players can see how they rank against other players on the leaderboard."
